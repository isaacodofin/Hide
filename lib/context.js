...
function buildContext(sock, message, extra = {}) {
    ...
    // ✅ 2. REPLY (No dependencies) - EDIT FEATURE ADDED
    const reply = async (content, options = {}) => {
        ...
        try {        
            ...
            // ✅ NEW: Add edit support
            if (options.edit !== undefined) {
                sendMessageOptions.edit = options.edit;
            }
            ...
            const validSendOptions = [
                ...
                'edit'  // ✅ NEW: Add edit to valid options
            ];
            ...
            delete messageOptions.edit;  // ✅ NEW: Clean up edit from messageOptions
            ...
            // ✅ NEW: Add edit support in fallback
            if (options.edit !== undefined) {
                sendMessageOptions.edit = options.edit;
            }
    ...
    // ✅ 3. REPLYPLAIN (No dependencies) - EDIT FEATURE ADDED
